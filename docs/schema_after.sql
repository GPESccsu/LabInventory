...
CREATE INDEX idx_inv_doc_project ON inv_doc(project_id);
CREATE INDEX idx_inv_doc_created ON inv_doc(created_at);
CREATE INDEX idx_inv_doc_type    ON inv_doc(doc_type);
...
CREATE INDEX idx_inv_line_doc  ON inv_line(doc_id);
CREATE INDEX idx_inv_line_part ON inv_line(part_id);
